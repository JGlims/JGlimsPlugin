...
public enum StructureType {
    ...
    // ── Schematic-imported structures (overworld) ──────────────────
    ANCIENT_OAK_TREE("Ancient Oak Tree", World.Environment.NORMAL, LegendaryTier.COMMON,
        21, 14, 18, false, null, 0,
        Set.of(Biome.FOREST, Biome.DARK_FOREST, Biome.OLD_GROWTH_BIRCH_FOREST, Biome.PLAINS)),
    BIG_TREE("Big Tree", World.Environment.NORMAL, LegendaryTier.COMMON,
        56, 58, 51, false, null, 0,
        Set.of(Biome.FOREST, Biome.DARK_FOREST, Biome.PLAINS)),
    TALL_TREE("Tall Tree", World.Environment.NORMAL, LegendaryTier.COMMON,
        10, 58, 13, false, null, 0,
        Set.of(Biome.FOREST, Biome.DARK_FOREST, Biome.JUNGLE, Biome.SPARSE_JUNGLE)),
    GREAT_OAK_TREE_MOSS("Great Oak Tree", World.Environment.NORMAL, LegendaryTier.COMMON,
        20, 19, 21, false, null, 0,
        Set.of(Biome.SWAMP, Biome.MANGROVE_SWAMP, Biome.DARK_FOREST)),
    CAVE_HOUSE("Cave House", World.Environment.NORMAL, LegendaryTier.COMMON,
        36, 32, 46, false, null, 0,
        Set.of(Biome.STONY_PEAKS, Biome.WINDSWEPT_HILLS, Biome.STONY_SHORE)),
    CLOCK_TOWER("Clock Tower", World.Environment.NORMAL, LegendaryTier.RARE,
        29, 50, 35, false, null, 0,
        Set.of(Biome.PLAINS, Biome.SUNFLOWER_PLAINS, Biome.MEADOW)),
    DARK_MANSION("Dark Mansion", World.Environment.NORMAL, LegendaryTier.RARE,
        71, 22, 73, true, "Mansion Keeper", 250,
        Set.of(Biome.DARK_FOREST, Biome.SWAMP, Biome.OLD_GROWTH_SPRUCE_TAIGA)),
    DESERT_CITY("Desert City", World.Environment.NORMAL, LegendaryTier.RARE,
        79, 25, 84, false, null, 0,
        Set.of(Biome.DESERT)),
    DESERT_HOUSE("Desert House", World.Environment.NORMAL, LegendaryTier.COMMON,
        45, 61, 97, false, null, 0,
        Set.of(Biome.DESERT)),
    GIANT_CHURCH("Giant Church", World.Environment.NORMAL, LegendaryTier.RARE,
        141, 43, 47, true, "Cathedral Guardian", 300,
        Set.of(Biome.PLAINS, Biome.SUNFLOWER_PLAINS, Biome.MEADOW)),
    GREAT_LIBRARY("Great Library", World.Environment.NORMAL, LegendaryTier.RARE,
        39, 36, 39, false, null, 0,
        Set.of(Biome.PLAINS, Biome.FOREST, Biome.BIRCH_FOREST)),
    GREAT_PYRAMID("Great Pyramid", World.Environment.NORMAL, LegendaryTier.EPIC,
        61, 39, 80, true, "Pharaoh", 400,
        Set.of(Biome.DESERT)),
    JAPANESE_PAGODA("Japanese Pagoda", World.Environment.NORMAL, LegendaryTier.RARE,
        45, 56, 66, false, null, 0,
        Set.of(Biome.CHERRY_GROVE, Biome.BAMBOO_JUNGLE, Biome.FOREST)),
    JUNGLE_TEMPLE_SCHEM("Jungle Temple", World.Environment.NORMAL, LegendaryTier.COMMON,
        15, 19, 23, false, null, 0,
        Set.of(Biome.JUNGLE, Biome.SPARSE_JUNGLE, Biome.BAMBOO_JUNGLE)),
    AZTEC_PYRAMID("Aztec Pyramid", World.Environment.NORMAL, LegendaryTier.EPIC,
        71, 52, 79, true, "Aztec Guardian", 500,
        Set.of(Biome.JUNGLE, Biome.SPARSE_JUNGLE, Biome.SAVANNA)),
    MAYA_TEMPLE("Maya Temple", World.Environment.NORMAL, LegendaryTier.RARE,
        49, 29, 48, false, null, 0,
        Set.of(Biome.JUNGLE, Biome.SPARSE_JUNGLE)),
    MEDIEVAL_MINE("Medieval Mine", World.Environment.NORMAL, LegendaryTier.COMMON,
        20, 20, 30, false, null, 0,
        null),
    MEDIEVAL_TAVERN_INN("Medieval Tavern", World.Environment.NORMAL, LegendaryTier.COMMON,
        19, 19, 31, false, null, 0,
        Set.of(Biome.PLAINS, Biome.SUNFLOWER_PLAINS, Biome.FOREST)),
    ROUND_MEDIEVAL_HOUSE("Round Medieval House", World.Environment.NORMAL, LegendaryTier.COMMON,
        31, 38, 39, false, null, 0,
        Set.of(Biome.PLAINS, Biome.SUNFLOWER_PLAINS, Biome.MEADOW)),
    RUSTIC_MOTT_BAILEY("Rustic Motte & Bailey", World.Environment.NORMAL, LegendaryTier.COMMON,
        24, 22, 21, false, null, 0,
        Set.of(Biome.PLAINS, Biome.FOREST, Biome.MEADOW)),
    SMALL_MEDIEVAL_CASTLE("Small Castle", World.Environment.NORMAL, LegendaryTier.RARE,
        31, 28, 36, true, "Castle Knight", 200,
        Set.of(Biome.PLAINS, Biome.MEADOW, Biome.STONY_PEAKS)),
    STONE_RUINS_SCHEM("Stone Ruins", World.Environment.NORMAL, LegendaryTier.COMMON,
        55, 30, 55, false, null, 0,
        null),
    BLACK_PEARL_SHIP("Black Pearl Ship", World.Environment.NORMAL, LegendaryTier.EPIC,
        90, 74, 35, true, "Ghost Captain", 350,
        Set.of(Biome.BEACH, Biome.STONY_SHORE, Biome.OCEAN, Biome.DEEP_OCEAN)),
    TOWER_OF_GODS("Tower of Gods", World.Environment.NORMAL, LegendaryTier.EPIC,
        39, 81, 39, true, "Divine Sentinel", 600,
        Set.of(Biome.STONY_PEAKS, Biome.WINDSWEPT_HILLS, Biome.MEADOW));
